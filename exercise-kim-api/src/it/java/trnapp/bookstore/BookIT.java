...
public class BookIT extends BaseITCase {
	...
	public void testSave() {
		...
		String chapter1Title = "DUNE";
		String chapter2Title = "MUAD'DIB";
		String chapter3Title = "THE PROPHET";
		
		Chapter book1Chapter1 = new Chapter();
		book1Chapter1.setNumber(new Integer(1));
		book1Chapter1.setTitle(chapter1Title);
		
		Chapter book1Chapter2 = new Chapter();
		book1Chapter2.setNumber(new Integer(2));
		book1Chapter2.setTitle(chapter2Title);
		
		Chapter book1Chapter3 = new Chapter();
		book1Chapter3.setNumber(new Integer(3));
		book1Chapter3.setTitle(chapter3Title);
		
		book1.getChapters().add(book1Chapter1);
		book1.getChapters().add(book1Chapter2);
		book1.getChapters().add(book1Chapter3);		
		...
		List<Chapter> chapters = book2.getChapters();
		assertEquals("Book should have 3 chapters", 3, chapters.size());
		
		Chapter chapter1 = chapters.get(0);
		assertEquals(1, chapter1.getNumber());
		assertEquals(chapter1Title, chapter1.getTitle());
		
		Chapter chapter2 = chapters.get(1);
		assertEquals(2, chapter2.getNumber());
		assertEquals(chapter2Title, chapter2.getTitle());
		
		Chapter chapter3 = chapters.get(2);
		assertEquals(3, chapter3.getNumber());
		assertEquals(chapter3Title, chapter3.getTitle());
